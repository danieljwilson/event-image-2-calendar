...
- **LLM Extraction** — multi-provider: currently **OpenAI GPT-5.4 nano** (`gpt-5.4-nano-2026-03-17`), Anthropic Claude available as fallback. Worker auto-routes by model prefix.
