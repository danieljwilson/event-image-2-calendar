    ...
    var body: some View {
        Form {
            ...
            Section("About") {
                ...
                Link("Privacy Policy", destination: APIConfiguration.workerBaseURL.appendingPathComponent("legal/privacy"))
                Link("Terms of Service", destination: APIConfiguration.workerBaseURL.appendingPathComponent("legal/terms"))
